...
class GetMyAdsUseCase @Inject constructor(
    private val profileRep: ProfileRepository
) {
    private var myAdsEntity = MyAdsEntity(statuses = listOf("active", "cancelled", "moderate", "disabled"))

    operator fun invoke(token: String ) = profileRep.getMyNonActiveAds(token, myAdsEntity)
